...
private static final char allchar[][] = {
    ...
    {0x06D3, 0x0804, 0xFBB0, 0xFBB1, 0xFBB1, 0xFBB1} 
         ...
         public static String reshape_normal(String Str){
             String Temp=" "+Str+" ";
             char pre,at,post;
      	...
      	public static String reshape(Context context ,String Str)
     	{
      		...
      		int ResharpMode = prefs.getInt("ResharpMode", 1);
      		...
      		switch(ResharpMode)
      		{
      			...
      			case 4:
      				result = reshape_reverse(Str);
          			break;
          			
      			case 5:
      				result = reshape_reverse(new StringBuffer(Str).reverse().toString());
          			break;
