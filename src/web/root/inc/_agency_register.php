...
function _agency_register(){
	...
	<tr height=30 >
		<td bgcolor=#f4f4f4 style='font-size:16px;'>&nbsp; &nbspثبت نام</td>
		<td bgcolor=#f4f4f4 align=left ></td>
	</tr>
	<tr height=30 ><td colspan=2 ><hr color=#cccccc size=1px style='height:1px; border:1px solid #eee;' ></td></tr>
	</table>
	";
	...
	<form method=post name="naForm" enctype="multipart/form-data" action="./?do=<?=$_REQUEST['do']?>&op=add" onsubmit="
